...
const highlights = [
  ...
  "Only $5,000 Course Fee",
  "Drive - Full Access Given",
];
  ...
  return (
    <section className="relative overflow-hidden bg-white py-12 sm:py-16 lg:py-20">
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center px-5 text-center sm:px-8">
        ...
        >
          <GraduationCapIcon className="h-5 w-5 shrink-0 text-brand-blue" />
        ...
        >
          Learn to Trade{" "}
          <span className="text-brand-blue">Forex and Crypto</span> with Sir
          Yasir
        ...
        >
          A focused 2-month mentorship program combining real theory, trading
          strategies, live market sessions, and hands-on practice, Q &amp; A
          sessions to build you into a disciplined, profitable, and confident
          trader.
        </motion.p>
        ...
        <motion.div
          ...
          animate="visible"
          variants={fadeUp}
          className="mt-8 flex w-full max-w-2xl flex-col items-stretch justify-center gap-3 sm:flex-row sm:flex-nowrap sm:items-center"
        >
          <Link
            href={WHATSAPP_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full bg-brand-blue px-5 py-3.5 text-sm font-semibold text-white shadow-[0_10px_28px_rgba(37,99,235,0.32)] transition-all hover:-translate-y-0.5 hover:bg-brand-blue-hover hover:shadow-[0_14px_32px_rgba(37,99,235,0.38)] sm:flex-1 sm:text-[15px]"
          >
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full bg-[#25D366] px-5 py-3.5 text-sm font-semibold text-white shadow-[0_10px_28px_rgba(37,211,102,0.3)] transition-all hover:-translate-y-0.5 hover:bg-[#1ebe5b] hover:shadow-[0_14px_32px_rgba(37,211,102,0.4)] sm:flex-1 sm:text-[15px]"
          >
          ...
          <Link
            href="/#join-signals"
            className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full border-2 border-brand-blue bg-white px-5 py-3.5 text-sm font-semibold text-brand-blue transition-all hover:-translate-y-0.5 hover:bg-blue-50/80 sm:flex-1 sm:text-[15px]"
          >
